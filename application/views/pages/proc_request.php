...
<div id ="content">
    <div class="container-fluid">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xs-6">
                            ...
                            $proc_details = $this->processing->identify([
                                'proc_id'=>$proc_id
                            ]);
                            ?>
                            <h3>
                        ...
                        <div class="col-xs-6 text-right">
                            <h3>
                                <?= $request['rproc_quantity'] ?>
                                <small>kg</small><br />
                                <small class="text-lowercase">for <?= $proc_details['proc_activity'] ?></small>
                            </h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-horizontal">
                    ...
                    if (!empty($offer_error)) {
                        form_pieces::create_alert([
                            'context'=>'warning',
                            'label'=>'Could not edit processing service.',
                            'text'=>$offer_error,
                        ]);
                    }
                    ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
            <?=
            form_open('orders/proc/'.$request_string, 'class="form-horizontal"');
            ?>
                <div class="container-fluid">
                <?php
                switch ($request['rproc_status']) {
                    case 0:
                    case 1: {
                ?>
                <div class="h4 lil-header">Evaluation</div>
                <?php
                if (in_array($request['rproc_status'],
                            $this->request_processing->get_progressStatuses([
                                'is_seller'=>$is_seller
                            ])
                    )) {
                ?>
                ...
                <div class="row">
                    <div class="col-xs-12 text-center">
                        <div class="btn-group btn-group-lg">
                            <button type="submit" id="offerproc" name="offerproc" value="yes" class="btn btn-success">
                                <span class="fas fa-check-circle"></span>
                                <br />
                                <small>Accept</small>
                            </button>
                            <button type="submit" id="offerproc" name="offerproc" value="no" class="btn btn-danger">
                ...
                <fieldset>
                    ...
                    $label_size = 'col-md-3';
                    $input_size = 'col-md-6';
                    $supposed_procnotes = $request['rproc_procnotes'];
                    if (set_value('proc_notes') !== '') {
                        $supposed_procnotes = set_value('proc_notes');
                    }
                    form_pieces::create_textareafield([
                        ...
                        'value'=> $supposed_procnotes,
                    ]);
                    $supposed_quantity = $request['rproc_quantity'];
                    ...
                    $supposed_duedate = $request['rproc_duedate'];
                    ...
                    $supposed_memberuse = $request['rproc_deliverto'];
                    if (set_value('use_member') !== '') {
                        $supposed_memberuse = set_value('use_member');
                    }
                    $supposed_memberuse_string = $this->address->get_string(['a_id'=>$request['rproc_deliverto']]);
                    ...
                    if (!$is_seller || $proc_details['proc_address'] !== $my_address['a_id']) {
                        array_push($my_address_list,
                    ...
                    $supposed_delivernotes = $request['rproc_delivernotes'];
                    if (set_value('notes') !== '') {
                    ...
                    form_pieces::create_submitbutton([
                        ...
                        'label'=>'Finished?',
                        'button_name'=>'negproc',
                        'button_text'=>'Negotiate this process',
                    ]);
                    ?>
                </fieldset>
                <?php
                    ...
                    case 2: {
                        ...
                        <fieldset>
                            ...
                            <hr />
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="sendproc">Finished?</label>
                                <div class="col-md-6">
                                    <button id="sendproc" name="sendproc" class="btn btn-primary" type="submit">
                                        Send order
                                    </button>
                                </div>
                            </div>
                        ...
                        $that_store_orderdays = $this->request_history->get_entry([
                            'request_id' => $request['rproc_id'],
                            'type' => 'proc',
                            'inquiry' => 's_editdays',
                        ]);
                        $timestamp = date('Y-m-d H:i:s');
                        $datetime1 = new DateTime($request['rproc_created']);
                        $datetime2 = new DateTime($timestamp);
                        $interval = $datetime1->diff($datetime2);
                        $datediffdays = $interval->format('%R%d');
                        // echo $request['rproc_created']." vs. ".$timestamp;
                    ...
                    case 3: {
                        ...
                        ?>
                            ...
                            -->
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="receiveproc">Received in good condition?</label>
                                <div class="col-md-6">
                                    <button id="receiveproc" name="receiveproc" value="1" class="btn btn-success" type="submit">
                    ...
                    <fieldset>
                        ...
                        -->
                        <div class="form-group">
                            <label class="col-md-3 control-label" for="payproc">Paid in full?</label>
                            <div class="col-md-6">
                                <button id="payproc" name="payproc" value="1" class="btn btn-success" type="submit">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                            <span>
                                <?=
                                $this->request_processing->get_thatStatus([
                                    'is_seller' => $is_seller,
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                            <span>
                                <?= $request['rproc_duedate'] ?>
                            </span>
                        </div>
                    </div>
                    <?php
                    if (!empty($request['rproc_procnotes'])) {
                    ?>
                    <div class="row">
                    ...
                    <?php
                    if (!empty($request['rproc_delivernotes'])) {
                    ?>
                    <div class="row">
                        <div class="col-xs-12 text-left">
                            <label class="control-label">
                    ...
                    ?>
                    <?php
                    $request_ship = $this->request_processing->get_thatShip([
                        'rproc_id'=>$request_id
                    ]);
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 text-right">
                            <span>
                                <?php
                                if (!empty($request_ship['rprocsh_trackno'])) {
                                    echo $request_ship['rprocsh_trackno'];
                                }
                                else {
                                    echo "None";
                                }
            ...
            <?php
            if (!in_array($request['rproc_status'],
                        $this->request_processing->get_eventStatuses([
                        ])
                    )) {
                    if (!empty($m_id)) {
                        ...
                        $given_subject = "Request inquiry for ".$proc_details['proc_activity']." at ".$this->address->get_string([
                            'a_id'=>$proc_details['proc_address'],
                            'pref'=>'c,p'
                        ]);
